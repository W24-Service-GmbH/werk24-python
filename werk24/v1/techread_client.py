...
from werk24.v1.auth_client import AuthClient
from werk24.v1.crypt import (
    decrypt_with_private_key,
    encrypt_with_public_key,
    generate_new_key_pair,
)
from werk24.v1.exceptions import (
    BadRequestException,
...
from werk24.v1.models.ask import W24Ask
from werk24.v1.models.helpdesk import W24HelpdeskTask
from werk24.v1.models.techread import (
    W24TechreadAction,
...
from werk24.v1.techread_client_https import TechreadClientHttps
from werk24.v1.techread_client_wss import TechreadClientWss
...
class W24TechreadClient:
    ...
    async def _send_command_read(
        ...
        async for message in self._techread_client_wss.listen():
            logger.debug(
                "Received message %s:%s", message.message_type, message.message_subtype
            )
    ...
    def make_from_token(
        ...
        client = W24TechreadClient(
            server_wss, version, wss_close_timeout=wss_close_timeout
        )
