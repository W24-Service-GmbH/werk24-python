...
from werk24.v1.crypt import decrypt_with_private_key, encrypt_with_public_key
...
from werk24.v1.models.ask import W24AskUnion
from werk24.v1.models.helpdesk import W24HelpdeskTask
from werk24.v1.models.techread import W24PresignedPost, W24TechreadWithCallbackPayload
...
class TechreadClientHttps:
    ...
    async def download_payload(
        ...
        - bytes: Payload
        """
        logger.debug("Downloading payload")
