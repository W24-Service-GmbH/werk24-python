...
from werk24.v1.exceptions import ServerException, UnauthorizedException
from werk24.v1.models.techread import W24TechreadCommand, W24TechreadMessage
...
class TechreadClientWss:
    ...
    async def listen(
        self, max_messages_per_session: int = 100
