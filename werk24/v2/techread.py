...
from werk24.v2.crypt import decrypt_with_private_key, encrypt_with_public_key
from werk24.v2.defaults import Settings
from werk24.v2.exceptions import (
    BadRequestException,
    EncryptionException,
...
from werk24.v2.license import find_license
from werk24.v2.logger import get_logger
...
class Werk24Client:
    ...
    async def init_request(
        ...
        try:
            response = TechreadInitResponse.model_validate(message.payload_dict)
    ...
    def _parse_message(message_raw: str) -> TechreadMessage:
        ...
        try:
            ...
            try:
                ...
                logger.error("Raw message is not valid JSON: %s", message_raw)
            ...
            if error_message == "Forbidden":
                logger.error("Action forbidden: %s", message_raw)
