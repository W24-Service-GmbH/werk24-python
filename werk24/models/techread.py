...
from .asks import ASK_SUBCLASSES, AskResponse, AskType, AskUnion
...
class TechreadMessage(TechreadBaseResponse):
    ...
    page_number: int = 0
    payload_dict: Optional[AskResponse | TechreadInitResponse | W24AskResponse] = None
    ...
    def deserialize_payload(
        ...
        v: Any,
        info: ValidationInfo,
    ) -> Optional[AskResponse | TechreadInitResponse]:
        ...
        if info.data["message_subtype"] in ASK_SUBCLASSES.values():
            return AskResponse.model_validate(v)
